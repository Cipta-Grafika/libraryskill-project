...
export default async function AdminSkillDetailPage({ params }: AdminSkillDetailPageProps) {
  ...
  return (
    <div className="review-container">
      <Link href="/admin/skills" className="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-200 mb-6 transition-colors">
