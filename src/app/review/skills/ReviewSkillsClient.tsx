...
export default function ReviewSkillsClient({ initialSkills }: { initialSkills: SkillData[] }) {
      ...
      {filteredSkills.length === 0 ? (
        <div className="review-empty-state">
          ...
          <p className="review-empty-desc">
            {searchQuery ? "No skills matched your search criteria." : "There are no submitted skills to display yet."}
          </p>
        </div>
      ) : (
